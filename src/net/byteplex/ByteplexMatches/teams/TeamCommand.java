...
public class TeamCommand implements CommandExecutor {
    ...
    public boolean onCommand(CommandSender sender, Command cmd, String commandLabel, String[] args) {
            ...
            if (sender instanceof Player) {
                ...
                if (input_team.equals("red") || input_team.equals("blue")) {
                    ...
                    if (teams_map.isEmpty()) {
                        ...
                        p.sendMessage(ChatFormat.formatExclaim(ChatLevel.INFO, "You have joined the " + ((teams_map.get(p.getUniqueId()).equals("blue")) ? ChatColor.BLUE : ChatColor.RED) + input_team + " team!"));
                    }
                    //  if player is already in a team and wants to switch
                        ...
                        if ((teams_map.get(p.getUniqueId()).equals(input_team))) {
                            p.sendMessage(ChatFormat.formatExclaim(ChatLevel.INFO, "You are already on the " + ((teams_map.get(p.getUniqueId()).equals("blue")) ? ChatColor.BLUE : ChatColor.RED) + input_team + " team!"));
                        }
        ...
        //  tell player his current team or to join appropriate team
        else {
            if (sender instanceof Player) {
                Player p = (Player) sender;
                if (teams_map.containsKey(p.getUniqueId())) {
                    p.sendMessage(ChatFormat.formatExclaim(ChatLevel.INFO, "You are on the " + ((teams_map.get(p.getUniqueId()).equals("blue")) ? ChatColor.BLUE : ChatColor.RED) + teams_map.get(p.getUniqueId()) + " team!"));
                } else {
